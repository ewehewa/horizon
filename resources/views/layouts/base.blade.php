...
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/bootstrap.min.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/flaticon.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/remixicon.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/owl.carousel.min.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/odometer.min.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/fancybox.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/aos.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/style.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/responsive.css">
<link rel="stylesheet" href="{{ request()->getBasePath() }}/temp/custom/assets/css/dark-theme.css">
...
<footer class="footer-wrap">
  ...
  <script data-cfasync="false" src="https://cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.html"></script><script src="{{ request()->getBasePath() }}/temp/custom/assets/js/jquery.min.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/bootstrap.bundle.min.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/form-validator.min.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/contact-form-script.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/aos.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/owl.carousel.min.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/odometer.min.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/jquery.countdown.min.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/fancybox.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/jquery.appear.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/tweenmax.min.js"></script>
  <script src="{{ request()->getBasePath() }}/temp/custom/assets/js/main.js"></script>
