...
<style>
    ...
    #preloader {
      ...
      height: 100%;
      overflow: visible;
      background: #fff url("{{ request()->getBasePath() }}/temp/custom/img/preloader.html") no-repeat center center;
    }
    ...
    */
    ...
    #hero {
      width: 100%;
      height: 100vh;
      background: url("{{ request()->getBasePath() }}/temp/custom/img/Event_Header.jpg") top center;
    ...
    --------------------------------------------------------------*/
    #about {
      background: url("{{ request()->getBasePath() }}/temp/custom/img/about-bg.jpg");
      background-size: cover;
      overflow: hidden;
      position: relative;
      color: #fff;
    ...
    #herod {
      width: 100%;
      height: 70vh;
      background: url("{{ request()->getBasePath() }}/temp/custom/img/bsv.jpg") top center;
      background-size: cover;
      overflow: hidden;
      position: relative;
    }
    ...
    #venue .venue-info {
      background: url("{{ request()->getBasePath() }}/temp/custom/img/venue-info-bg.html") top center no-repeat;
      background-size: cover;
      position: relative;
      padding-top: 60px;
      padding-bottom: 60px;
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              <img src="{{ request()->getBasePath() }}/temp/custom/img/micheal.jpg" alt="Speaker 1" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="200">
              <img src="{{ request()->getBasePath() }}/temp/custom/img/david.jpg" alt="Speaker 2" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="300">
              <img src="{{ request()->getBasePath() }}/temp/custom/img/nicola.jpg" alt="Speaker 3" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              <img src="{{ request()->getBasePath() }}/temp/custom/img/lara.jpg" alt="Speaker 4" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="200">
              <img src="{{ request()->getBasePath() }}/temp/custom/img/damien.jpg" alt="Speaker 5" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="300">
              <img src="{{ request()->getBasePath() }}/temp/custom/img/james.jpg" alt="Speaker 6" class="img-fluid">
              <div class="details">
