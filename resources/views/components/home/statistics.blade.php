                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="count-item"> 
                        <div class="count-item__icon"style="width: 100%;"> 
                          <svg class="svg-icon">
                            <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-002-pie-chart"></use>
                          </svg>
                        </div>
                    ...
                    <div class="swiper-slide">
                      <div class="count-item"> 
                        <div class="count-item__icon"style="width: 100%;"> 
                          <svg class="svg-icon">
                            <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-003-people"></use>
                          </svg>
                        </div>
                    ...
                    <div class="swiper-slide">
                      <div class="count-item"> 
                        <div class="count-item__icon"style="width: 100%;"> 
                          <svg class="svg-icon">
                            <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-001-money"></use>
                          </svg>
                        </div>
                    ...
                    <div class="swiper-slide">
                      <div class="count-item"> 
                        <div class="count-item__icon"style="width: 100%;"> 
                          <svg class="svg-icon">
                            <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-004-withdraw"></use>
                          </svg>
                        </div>
