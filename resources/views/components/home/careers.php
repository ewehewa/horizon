...
#preloader {
  ...
  height: 100%;
  overflow: visible;
  background: #fff url("{{ request()->getBasePath() }}/temp/img/preloader.html") no-repeat center center;
}
...
#hero {
  width: 100%;
  height: 80vh;
  background: url("{{ request()->getBasePath() }}/temp/custom/img/Career1.png") top center;
