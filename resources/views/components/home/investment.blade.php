...
<div data-deposit="Premium" >
    ...
    <script src="{{ request()->getBasePath() }}/temp/custom/js/jquery.min.js"></script>
            ...
            <section class="steps">
              <div class="container">
                ...
                <div class="steps__slider swiper-container swiper-no-swiping js-swiper-steps">
                  <div class="steps__hearts"> <img src="{{ request()->getBasePath() }}/temp/custom/assets/images/steps/1.png" alt=""><img src="{{ request()->getBasePath() }}/temp/custom/assets/images/steps/2.png" alt="">
                  </div>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="funds-item"> 
                        <div class="funds-item__icon"> <img src="{{ request()->getBasePath() }}/temp/custom/assets/images/funds/1.png" alt="">
                        </div>
                    ...
                    <div class="swiper-slide">
                      <div class="funds-item is-active">
                        <div class="funds-item__icon"> <img src="{{ request()->getBasePath() }}/temp/custom/assets/images/funds/2.png" alt="">
                        </div>
                    ...
                    <div class="swiper-slide">
                      <div class="funds-item"> 
                        <div class="funds-item__icon"> <img src="{{ request()->getBasePath() }}/temp/custom/assets/images/funds/3.png" alt="">
                        </div>
              ...
              <div class="payments-and-footer-wrapper__inner"style="padding-top: 70px;">
                  ...
                  <div class="container">
                    <div class="payments__row"> 
                      <div class="payments__col"> <img src="{{ request()->getBasePath() }}/temp/custom/assets/images/payments/payment.png" alt="">
                      </div>
