...
<div class="content-wrapper">
  ...
  <div class="partner-item">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/partner/partner-7.png" alt="Image">
  </div>
  </div>
  </div>
  </div>
  ...
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/about-shape-4.png" alt="Image" class="about-shape-one bounce">
  <div class="about-img">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/about-img-1.jpg" alt="Image">
  </div>
  <div class="about-img">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/about-img-2.jpg" alt="Image">
  </div>
  </div>
  <div class="col-6 about-img-wrap lgm-70">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/shape-1.png" alt="Image" class="about-shape-two moveHorizontal">
  <div class="about-img">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/about-img-3.jpg" alt="Image">
  </div>
  <div class="about-img">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/about-img-4.jpg" alt="Image">
  </div>
  </div>
  </div>
  </div>
  ...
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/shape-6.png" alt="Image" class="wh-shape-one animationFramesTwo">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/why-choose-us/wh-img-7.jpg" alt="Image">
  </div>
  </div>
  </div>
  </div>
  ...
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/shape-4.png" alt="Image" class="app-shape-one bounce">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/app-screen.png" alt="Image">
  </div>
  </div>
  <div class="col-lg-6">
  ...
  <a href="app">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/play-store.png" alt="Image">
  </a><a href="app">
  <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/app-store.png" alt="Image">
  </a>
  </div>
  </div>
  </div>
