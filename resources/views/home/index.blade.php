...
<section class="hero-wrap style2">
    ...
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/hero/hero-shape-4.png" alt="Image" class="hero-shape-one">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/hero/hero-shape-5.png" alt="Image" class="hero-shape-two">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/hero/hero-shape-6.png" alt="Image" class="hero-shape-three">
    </div>
    ...
    <a href="contact">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/testimonials/client-1.jpg" alt="Image">
    </a>
    <a href="contact">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/testimonials/client-2.jpg" alt="Image">
    </a>
    <a href="contact">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/testimonials/client-3.jpg" alt="Image">
    </a>
    </div>
    ...
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/hero/hero-img-2.jpg" alt="Image">
    </div>
    <div class="hero-img-two">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/hero/hero-img-3.jpg" alt="Image">
    </div>
    </div>
    </div>
    </div>
    ...
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/partner/partner-1.png" alt="Image">
    </div>
    <div class="partner-item">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/partner/partner-2.png" alt="Image">
    </div>
    <div class="partner-item">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/partner/partner-3.png" alt="Image">
    </div>
    <div class="partner-item">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/partner/partner-4.png" alt="Image">
    </div>
    <div class="partner-item">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/partner/partner-5.png" alt="Image">
    </div>
    <div class="partner-item">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/partner/partner-6.png" alt="Image">
    </div>
    </div>
    </div>
    </div>
    ...
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/shape-1.png" alt="Image" class="about-shape-one">
    <div class="about-img-one">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/about-img-5.jpg" alt="Image">
    </div>
    <div class="about-img-two">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/about/about-img-6.jpg" alt="Image">
    </div>
    </div>
    </div>
    ...
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/shape-2.png" alt="Image" class="wh-shape-one moveHorizontal">
    <div class="wh-img">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/why-choose-us/wh-img-4.jpg" alt="Image">
    </div>
    <div class="wh-img">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/why-choose-us/wh-img-5.jpg" alt="Image">
    </div>
    </div>
    <div class="col-6 wh-img-wrap">
    <div class="wh-img">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/shape-3.png" alt="Image" class="wh-shape-two bounce">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/why-choose-us/wh-img-6.jpg" alt="Image">
    </div>
    </div>
    </div>
    </div>
    ...
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/usa.png" alt="Image">
    US Dollar
    </div>
    </td>
    <td>
    ...
    <td>
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/chart-img/chart-1.png" alt="Image">
    </td>
    <td>
    ...
    <td>
    <div class="country-flag">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/japan.png" alt="Image">
    Japanees Yen
    </div>
    </td>
    <td>
    ...
    <td>
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/chart-img/chart-2.png" alt="Image">
    </td>
    <td>
    <button class="btn style1" type="button"><i class="ri-send-plane-line"></i>Send</button>
    </td>
    ...
    <td>
    <div class="country-flag">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/uk.png" alt="Image">
    British Pound
    </div>
    </td>
    <td>
    ...
    <td>
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/chart-img/chart-3.png" alt="Image">
    </td>
    <td>
    <button class="btn style1" type="button"><i class="ri-send-plane-line"></i>Send</button>
    </td>
    ...
    <td>
    <div class="country-flag">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/newzland.png" alt="Image">
    Newzland Dollar
    </div>
    </td>
    <td>
    ...
    <td>
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/chart-img/chart-4.png" alt="Image">
    </td>
    <td>
    <button class="btn style1" type="button"><i class="ri-send-plane-line"></i>Send</button>
    </td>
    ...
    <td>
    <div class="country-flag">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/canada.png" alt="Image">
    Canadian Dollar
    </div>
    </td>
    <td>
    ...
    <td>
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/chart-img/chart-5.png" alt="Image">
    </td>
    <td>
    <button class="btn style1" type="button"><i class="ri-send-plane-line"></i>Send</button>
    </td>
    ...
    <td>
    <div class="country-flag">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/france.png" alt="Image">
    Swiss Franc
    </div>
    </td>
    <td>
    ...
    <td>
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/chart-img/chart-6.png" alt="Image">
    </td>
    <td>
    <button class="btn style1" type="button"><i class="ri-send-plane-line"></i>Send</button>
    </td>
    ...
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/usa.png" alt="Image"></div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/eu.png" alt="Image"></div>
    <div class="currency-info">
    <h3>EUR - Euro</h3>
    <p></p>
    </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/uk.png" alt="Image"></div>
    <div class="currency-info">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/canada.png" alt="Image"></div>
    <div class="currency-info">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/images/197582.png" alt="Image"></div>
    <div class="currency-info">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/japan.png" alt="Image"></div>
    <div class="currency-info">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/images/197375.png" alt="Image"></div>
    <div class="currency-info">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/newzland.png" alt="Image"></div>
    <div class="currency-info">
    <h3>NZD - NZ Dollar</h3>
    <p></p>
    </div>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="currency-card">
    <div class="currency-flag"><img src="{{ request()->getBasePath() }}/temp/custom/assets/img/flag/france.png" alt="Image"></div>
    <div class="currency-info">
    ...
    <div class="client-info-wrap">
    <div class="client-img">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/testimonials/client-4.jpg" alt="Image">
    </div>
    <div class="client-info">
    <h3>Alex Cruis</h3>
    <span>CEO, IBAC</span>
    ...
    <div class="client-info-wrap">
    <div class="client-img">
     <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/testimonials/client-5.jpg" alt="Image">
    </div>
    <div class="client-info">
    <h3>Tom Haris</h3>
    ...
    <div class="blog-img">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/blog/blog-1.jpg" alt="Image">
    ...
    <div class="blog-card style2">
    <div class="blog-img">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/blog/blog-2.jpg" alt="Image">
    ...
    <div class="blog-card style2">
    <div class="blog-img">
    <img src="{{ request()->getBasePath() }}/temp/custom/assets/img/blog/blog-3.jpg" alt="Image">
...
_smartsupp.key = '72ebd859be0426c6e9a950ee7b05158398184608';
