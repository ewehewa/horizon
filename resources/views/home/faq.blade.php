                ...
                <ul class="accordion">
                  <li class="accordion__item">
                    <div class="accordion__category-item" data-accordion="trigger">
                      <div class="accordion__icon"> 
                        <svg class="svg-icon">
                          <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-triangles"></use>
                        </svg>
                      </div>
                  ...
                  <li class="accordion__item">
                    <div class="accordion__category-item" data-accordion="trigger">
                      <div class="accordion__icon"> 
                        <svg class="svg-icon">
                          <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-coins"></use>
                        </svg>
                      </div>
                      <div class="accordion__item-content">
...
After depositing, watch your capital grow by accumulating daily profit in real time.<br></p>
                  ...
                  <li class="accordion__item">
                    <div class="accordion__category-item" data-accordion="trigger">
                      <div class="accordion__icon"> 
                        <svg class="svg-icon">
                          <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-percent"></use>
                        </svg>
                      </div>
                      <div class="accordion__item-content">
...
Maximum Amount: <b>75000</b> usd, <b>1.5</b> btc, <b>20</b> eth, <b>300</b> ltc, <b>350000</b> doge, <b>750000</b> trx, <b>75000</b> usdt,   </p>
                  ...
                  <li class="accordion__item">
                    <div class="accordion__category-item" data-accordion="trigger">
                      <div class="accordion__icon"> 
                        <svg class="svg-icon">
                          <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-shield"></use>
                        </svg>
                      </div>
                      <div class="accordion__item-content">
...
After you have made sure that the entered data is correct, you need to go to the 'Withdrawal' section located in your investor's personal account, select the payment system to which you want to withdraw, enter the withdrawal amount and click the withdrawal button funds.</p>
                  ...
                  <li class="accordion__item">
                    <div class="accordion__category-item" data-accordion="trigger">
                      <div class="accordion__icon"> 
                        <svg class="svg-icon">
                          <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-question"></use>
                        </svg>
                      </div>
                      <div class="accordion__item-content">
                  ...
                  <li class="accordion__item">
                    <div class="accordion__category-item" data-accordion="trigger">
                      <div class="accordion__icon"> 
                        <svg class="svg-icon">
                          <use href="{{ request()->getBasePath() }}/temp/custom/assets/icons/sprite.svg#icon-settings"></use>
                        </svg>
                      </div>
                      <div class="accordion__item-content">
