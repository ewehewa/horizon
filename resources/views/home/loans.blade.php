                         ...
                         <div class="col-sm-12">
                            <div class="panel panel-default">
                             <div class="panel-body">
                               <h4 style=""><img  src="{{ request()->getBasePath() }}/temp/custom/images/3527271.png" width="25px"> &nbsp;LOAN DETAILS</h4>
                               <hr>

                               <div class="row">

                                <div class="col-sm-3" align="center">
                                 <img  src="{{ request()->getBasePath() }}/temp/custom/images/5207009.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
                                ...
                                <div class="col-sm-3" align="center">
                                  <img  src="{{ request()->getBasePath() }}/temp/custom/images/4221696.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
                                 ...
                                 <div class="col-sm-3" align="center">
                                   <img  src="{{ request()->getBasePath() }}/temp/custom/images/3130571.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
                                 ...
                                 <div class="col-sm-3" align="center">
                                   <img  src="{{ request()->getBasePath() }}/temp/custom/images/2780256.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
...
<br><br><br>
                       ...
                       <div class="row">
                         ...
                         <div class="col-sm-4">
                            <img  src="{{ request()->getBasePath() }}/temp/custom/images/1907675.png" class="img-responsive" style="margin-top: 15px;" width="150">
                         </div>
                         <div class="col-sm-4">
