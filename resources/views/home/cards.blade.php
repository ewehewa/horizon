                         ...
                         <div class="col-sm-12">
                            <div class="panel panel-default">
                             <div class="panel-body">
                               <h4 style=""><img src="{{ request()->getBasePath() }}/temp/custom/images/3527271.png" width="25px"> &nbsp;CARD DETAILS</h4>
                               <hr>

                               <div class="row">

                                <div class="col-sm-3" align="center">
                                 <img src="{{ request()->getBasePath() }}/temp/custom/images/349221.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
                                ...
                                <div class="col-sm-3" align="center">
                                  <img src="{{ request()->getBasePath() }}/temp/custom/images/147258.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
                                 ...
                                 <div class="col-sm-3" align="center">
                                   <img src="{{ request()->getBasePath() }}/temp/custom/images/349228.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
                                 ...
                                 <div class="col-sm-3" align="center">
                                   <img src="{{ request()->getBasePath() }}/temp/custom/images/349230.png" class="img-responsive" style="margin-top: 15px;" width="50">
                                  <br>
...
<br><br><br>
                       ...
                       <div class="row">
                         ...
                         <div class="col-sm-4">
                            <img src="{{ request()->getBasePath() }}/temp/custom/images/1086741.png" class="img-responsive" style="margin-top: 15px;" width="150">
                         </div>
                         <div class="col-sm-4">
