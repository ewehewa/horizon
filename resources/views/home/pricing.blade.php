          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <div class="card">
                  <div class="card-img">
                    <img src="{{ request()->getBasePath() }}/temp/custom/img/foreximg.jpg" alt="...">
                  </div>
                  <div class="card-body">
              ...
              <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <div class="card">
                  <div class="card-img">
                    <img src="{{ request()->getBasePath() }}/temp/custom/img/cryptoimg.jpg" alt="...">
                  </div>
                  <div class="card-body">
              ...
              <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                <div class="card">
                  <div class="card-img">
                    <img src="{{ request()->getBasePath() }}/temp/custom/img/oilgas.jpg" alt="...">
                  </div>
                  <div class="card-body">
