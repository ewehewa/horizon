                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <p class="mb-1 text-{{ $text }}">
                                            <b>{{ config('currencies.'.Auth::user()->currency, '$') }}{{
                                                number_format(Auth::user()->account_bal, 2, '.', ',') }}</b>
                                        </p>
                            ...
                            <div class="p-3 card  shadow">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">{{ config('currencies.'.Auth::user()->currency, '$')
                                            }}{{ number_format(round($cbalance->usdt)) }}
                                        </small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <form method="POST" action="javascript:void(0)" id="exchnageform">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control text-{{ $text }} " name="source" id="sourceasset">
                                        @if ($moresettings->btc == 'enabled')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount" class="form-control text-{{ $text }} "
