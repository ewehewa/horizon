            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        <p>You currently have an active or pending loan application. You cannot apply for a new loan
                            until your current loan is completed or your application is processed.</p>
                        <p class="mt-2">Please check your <a href="{{ route('veiwloan') }}"
                                class="font-medium underline text-yellow-800 hover:text-yellow-900">existing loans</a>
    ...
    <div x-show="!showApplicationForm" class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Your information is protected with bank-level security
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-6 relative z-10">
                            ...
                            <div class="flex">
                                <div
                                    class="flex-shrink-0 h-10 w-10 rounded-full bg-primary-100 flex items-center justify-center mr-4 z-10">
                                    <span class="text-gray-600 font-bold">1</span>
                                </div>
                                <div class="pt-1">
                                    <h4 class="font-medium text-gray-900 mb-1">Apply Online</h4>
                                    <p class="text-sm text-gray-600">Complete our simple online application form with
                                        your details and loan requirements</p>
                                </div>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="pt-1">
                                    ...
                                    <p class="text-sm text-gray-600">Our team reviews your application and may contact
                            ...
                            <div class="flex">
                                ...
                                <div class="pt-1">
                                    ...
                                    <p class="text-sm text-gray-600">Once approved, the loan amount will be transferred
                                        to your account</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mb-8 bg-gray-50 rounded-xl p-5 border border-gray-100">
                    ...
                    <div class="space-y-3">
                        <div class="p-3 bg-white rounded-lg border border-gray-100">
                            ...
                            <p class="text-sm text-gray-600">You'll need identification, proof of income, and address
                                verification. Additional documents may be requested based on loan type.</p>
                        </div>

                        <div class="p-3 bg-white rounded-lg border border-gray-100">
                            <h4 class="font-medium text-gray-900 mb-1">How long does approval take?</h4>
                            <p class="text-sm text-gray-600">Standard applications are typically processed within 1-3
                                business days, depending on verification requirements.</p>
                        </div>

                        <a href="#"
                            class="text-primary-600 hover:text-primary-700 text-sm font-medium inline-flex items-center mt-2">
                            View all FAQs
                            <i data-lucide="chevron-right" class="h-4 w-4 ml-1"></i>
                        </a>
                    </div>
                ...
                <!-- Apply Now CTA -->
                <div
                    class="bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl p-6 text-center border border-primary-100">
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Ready to get started?</h3>
                    <p class="text-sm text-gray-600 mb-4">Apply now and get a decision on your loan application quickly
                    </p>
                    <button @click="showApplicationForm = true" x-bind:disabled="hasActiveLoan"
                    ...
                    <p x-show="hasActiveLoan" class="mt-3 text-xs text-gray-500">You already have an active or pending
                        loan application</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8">
                <div class="flex justify-between items-center mb-6">
                    <button @click="showApplicationForm = false"
                ...
                <form action="{{ route('loan') }}" method="post" x-ref="loanForm" @submit="isSubmitting = true">
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 p-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label for="amount" class="block text-sm font-medium text-gray-700 mb-1">
                                        Loan Amount ({{ Auth::user()->currency }}) <span class="text-red-500">*</span>
                                    </label>
                                    <div class="relative">
                                        <div
                                            class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <span class="text-gray-500">{{ config('currencies.'.Auth::user()->currency,
                                                '$') }}</span>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="duration" id="duration" x-model="duration"
                            ...
                            <div class="mt-5">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="facility" id="facility" x-model="facility"
                                        class="block w-full pl-10 pr-10 py-3 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all appearance-none"
                                        required>
                                        ...
                                        <option value="Local Purchase Orders Finance">Local Purchase Orders Finance
                                        </option>
                                        ...
                                        <option value="Health Finance Product Guideline">Health Finance Product
                                            Guideline</option>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="purpose" id="purpose" x-model="purpose"
                                        ...
                                        placeholder="Please describe the purpose of this loan..." rows="5"
                                        required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 p-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="income" id="income" x-model="income"
                                        class="block w-full pl-10 pr-10 py-3 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all appearance-none"
                                        required>
                                        <option value="2,000-5,000">{{ config('currencies.'.Auth::user()->currency, '$')
                                            }}2,000 - {{ config('currencies.'.Auth::user()->currency, '$') }}5,000
                                        </option>
                                        <option value="6,000-10,000">{{ config('currencies.'.Auth::user()->currency,
                                            '$') }}6,000 - {{ config('currencies.'.Auth::user()->currency, '$') }}10,000
                                        </option>
                                        <option value="11,000-20,000">{{ config('currencies.'.Auth::user()->currency,
                                            '$') }}11,000 - {{ config('currencies.'.Auth::user()->currency, '$')
                                            }}20,000</option>
                                        <option value="21,000-50,000">{{ config('currencies.'.Auth::user()->currency,
                                            '$') }}21,000 - {{ config('currencies.'.Auth::user()->currency, '$')
                                            }}50,000</option>
                                        <option value="100,000 and above">{{
                                            config('currencies.'.Auth::user()->currency, '$') }}100,000 and above
                                        </option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <i data-lucide="chevron-down" class="h-5 w-5 text-gray-400"></i>
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-3 text-sm">
                                ...
                                <p class="text-gray-500 mt-1">
                                    ...
                                    and complete. I authorize {{ $settings->site_name }} to verify my information and
                                    credit history.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:space-x-4">
                        <button type="submit"
                            ...
                            :disabled="isSubmitting" :class="{ 'opacity-60 cursor-not-allowed': isSubmitting }">
