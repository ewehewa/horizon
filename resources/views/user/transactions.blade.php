...
<!-- Debug Info Section -->
<div class="hidden bg-blue-50 border border-blue-200 rounded-md p-4 mb-6" x-data="{showDebug: false}"
    x-show="showDebug">
...
<div x-data="transactionApp()">
    ...
    <div class="mb-6">
        <div class="relative">
            ...
            <input type="search" x-model="search" @input="console.log('Searching for:', search)"
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col"
                            ...
                            Description</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Scope
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Created</th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors" id="kt_trx_110853544343568433_button">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{
                                config('currencies.'.Auth::user()->currency, '$') }}{{ $withdrawal->amount }} {{
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <a href="{{ route('previewtransfer', ['id' => $withdrawal->id]) }}"
                                class="inline-flex items-center px-2 py-1 text-xs font-medium rounded text-primary-700 hover:text-primary-800 hover:bg-primary-50 transition-colors">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors" id="{{ $withdrawal->id }}{{ $withdrawal->txn_id }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{
                                ...
                                number_format($withdrawal->amount, 2, '.', ',') }} {{ Auth::user()->currency }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-10 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-sm text-gray-500 mt-1 mb-4">Try adjusting your search or filter
                                    parameters</p>
                            </div>
                        </td>
                    </tr>
    ...
    <div x-show="showFilterModal" x-transition:enter="transition ease-out duration-300"
        ...
        x-transition:leave-end="opacity-0" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="filter-title"
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div x-show="showFilterModal" x-transition:enter="transition ease-out duration-300"
                ...
                @click="showFilterModal = false" aria-hidden="true">
            </div>
            ...
            <div x-show="showFilterModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="mt-5 space-y-4">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <input type="date" id="date-from" x-model="dateFrom"
                            ...
                            <div>
                                ...
                                <input type="date" id="date-to" x-model="dateTo"
                                    class="block w-full border border-gray-200 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="order-by" x-model="orderBy"
                            class="block w-full border border-gray-200 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500">
    ...
    <div x-show="showExportModal" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
        x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100"
        x-transition:leave-end="opacity-0" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="export-title"
        role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div x-show="showExportModal" x-transition:enter="transition ease-out duration-300"
                x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                ...
                x-transition:leave-end="opacity-0"
                class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity backdrop-blur-sm"
                @click="showExportModal = false" aria-hidden="true">
            </div>
            ...
            <div x-show="showExportModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="mt-5 space-y-4">
                    <div>
                        <label for="export-type" class="block text-sm font-medium text-gray-700 mb-1">File
                            Format</label>
                        <select id="export-type" x-model="exportType"
                            class="block w-full border border-gray-200 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <div>
                        ...
                        <select id="export-as" x-model="exportAs"
                            class="block w-full border border-gray-200 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <div>
                        <label for="statement-type" class="block text-sm font-medium text-gray-700 mb-1">Statement
                            Style</label>
                        <div class="grid grid-cols-2 gap-3 mt-2">
                            <div @click="statementStyle = 'modern'"
                            ...
                            <div @click="statementStyle = 'classic'"
                ...
                <div class="mt-6 flex justify-end">
                    <button @click="exportData()" type="button" id="export-button"
