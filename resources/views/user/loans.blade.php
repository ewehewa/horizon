...
<div x-data="{ 
        ...
        <div class="relative bg-gradient-to-r from-primary-600 to-primary-700 px-6 py-4">
            ...
            <div class="absolute left-0 right-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none"
                    class="h-6 w-full text-white fill-current">
                    <path
            ...
            <div class="mb-6">
                <div class="relative">
                    ...
                    <input type="search"
                        ...
                        placeholder="Search by loan purpose or amount..." wire:model="search" />
                </div>
            </div>

            <!-- Loan Applications Table -->
            <div class="overflow-x-auto" wire:loading.class.delay="opacity-50"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors cursor-pointer">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    ...
                                    number_format($loan->amount, 2) }} {{ Auth::user()->currency }}
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    @if($loan->duration == 1)
                                    {{ $loan->duration }} Month
                                    @elseif($loan->duration <= 12) {{ $loan->duration }} Months
                                        @else
                                        {{ floor($loan->duration / 12) }} {{ floor($loan->duration / 12) > 1 ? 'Years' :
                                        'Year' }}
    ...
    <!-- Filter Modal -->
    <div x-show="showFilterModal" x-cloak class="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center"
        ...
        <div class="relative bg-white rounded-lg w-full max-w-md mx-4 shadow-xl transform transition-all"
            ...
            <div class="p-5">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" id="dateRange"
                            ...
                            placeholder="Select date range" x-model="dateRange" wire:model="date" />
                    </div>

                    <div>
                        <label for="status" class="block text-sm font-medium text-gray-700 mb-1">Status</label>
                        <div class="relative">
                            <select id="status" x-model="status" wire:model="status"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="orderBy" x-model="orderBy" wire:model="orderBy"
                                class="block w-full px-3 py-2 bg-white border border-gray-200 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="perPage" x-model="perPage" wire:model="perPage"
                                class="block w-full px-3 py-2 bg-white border border-gray-200 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button wire:click="$refresh" @click="showFilterModal = false"
    ...
    <!-- Export Modal -->
    <div x-show="showExportModal" x-cloak class="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center"
        x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
        x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-200"
        x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
        <div class="fixed inset-0 bg-black bg-opacity-50 transition-opacity" @click="showExportModal = false"></div>
        ...
        <div class="relative bg-white rounded-lg w-full max-w-md mx-4 shadow-xl transform transition-all"
            ...
            <div class="p-5">
                ...
                <form wire:submit.prevent="save(Object.fromEntries(new FormData($event.target)))">
                    ...
                    <div class="space-y-5">
                        <div>
                            <label for="exportType" class="block text-sm font-medium text-gray-700 mb-1">File
                                Format</label>
                            <div class="relative">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="exportAs" name="exportAs" required
                                    class="block w-full px-3 py-2 bg-white border border-gray-200 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
