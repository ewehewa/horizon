                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <h1 class=" pl-2 d-inline text-primary">{{ $user->name }} {{ $user->middlename }} {{
                                        $user->lastname }}</h1><span></span>
                                    <div class="d-inline">
                                        <div class="float-right btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-lg-right">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/dashboard/undormant') }}/{{ $user->id }}">Turn
                                                    Off Domarnt Account</a>
                                                @else
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/dashboard/dormant') }}/{{ $user->id }}">Turn On
                                                    Dormant Account </a>
                                                @endif
                                                @if ($user->account_frozen)
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/dashboard/unfreeze-account') }}/{{ $user->id }}">Unfreeze
                                                    Account</a>
                                                @else
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/dashboard/freeze-account') }}/{{ $user->id }}">Freeze
                                                    Account</a>
                                                @endif
                            ...
                            <div class="p-3 mt-4 border rounded row ">
                                <div class="col-md-3">
                                    ...
                                    <p>{{ config('currencies.'.$user->currency, '$') }}{{
                                        number_format($user->account_bal) }}</p>
                                </div>
                                <div class="col-md-3">
                                    <h5>Account Limit</h5>
                                    <p>{{ config('currencies.'.$user->currency, '$') }}{{ number_format($user->limit) }}
                                    </p>
                                </div>
