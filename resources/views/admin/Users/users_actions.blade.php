         ...
         <div class="modal-content">
             ...
             <div class="form-group">
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group">
                        <h6 class="text-{{ $text }}">Account Limit ({{ config('currencies.' . $user->currency, $settings->currency) }}) </h6>
 ...
 <div id="clearacctModal" class="modal fade" role="dialog">
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body ">
                 <p class="">You are clearing account for {{ $user->name }} to {{ config('currencies.' . $user->currency, $settings->currency) }}0.00
                 </p>
