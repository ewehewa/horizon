                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="currency" name="currency" x-model="formData.currency"
                                            class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 appearance-none text-dark"
                                            required>
                                            <option value="" disabled selected>Select your currency</option>
                                            @foreach ($currencies as $key => $currSymbol)
                                                <option value="{{ $key }}" {{ old('currency') == $key ? 'selected' : '' }}>
                                                    {{ $key }} ({{ html_entity_decode($currSymbol) }})
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
