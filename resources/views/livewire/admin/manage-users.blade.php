                        ...
                        <div class="card shadow p-4 ">
                                        ...
                                        <div>
                                            <form>
                                                <div class="input-group">
                                                    <input wire:model.live.debounce.500ms='searchvalue'
                                                        class="form-control form-control-sm shadow-none search  text-{{ $text }}"
                                                        type="search" placeholder="name, username, email or phone"
                                                        aria-label="search" />
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <div class="card-footer py-2">
                                <div class="row align-items-center">
                                    <div class="col-12 col-md-auto mb-2 mb-md-0 d-flex flex-wrap">
                                        <select wire:model='pagenum' class="form-control form-control-sm text-{{ $text }} mr-1 mb-1" style="width:auto">
                                            <option>10</option>
                                            <option>20</option>
                                            <option>50</option>
                                            <option>100</option>
                                        ...
                                        <select wire:model='orderby' class="form-control form-control-sm text-{{ $text }} mr-1 mb-1" style="width:auto">
                                            <option value="id">id</option>
                                            <option value="name">Name</option>
                                            <option value="email">Email</option>
                                            <option value="created_at">Sign up date</option>
                                        </select>
                                        <select wire:model='orderdirection' class="form-control form-control-sm text-{{ $text }} mb-1" style="width:auto">
