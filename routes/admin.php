...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
	...
	Route::get('dashboard/freeze-account/{id}', [ManageUsersController::class, 'freezeAccount']);
	Route::get('dashboard/unfreeze-account/{id}', [ManageUsersController::class, 'unfreezeAccount']);
