...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
	Route::get('account-frozen', [ViewsController::class, 'frozen'])->name('account.frozen');
});

Route::middleware(['auth:sanctum', 'verified', 'check.frozen', 'complete.kyc'])->get('/dashboard', [ViewsController::class, 'dashboard'])->name('dashboard');

Route::middleware(['auth:sanctum', 'verified', 'check.frozen'])->prefix('dashboard')->group(function () {
