...
class ManageUsersController extends Controller
{
    ...
    public function freezeAccount($id)
    {
        ...
        return redirect()->back()->with('success', 'Action Successful! Account has been frozen.');
    }
    ...
    public function unfreezeAccount($id)
    {
        ...
        return redirect()->back()->with('success', 'Action Successful! Account has been unfrozen.');
    }
